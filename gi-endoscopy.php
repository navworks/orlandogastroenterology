...
<section class="inner-banner" style="background-image: url('images/innerbanner/bg.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h3 class="font-28">Upper GI Endoscopy</h3>
				</div>
			</div>
		</div>
</section>
		...
		<div class="row">
			<div class="col-sm-8">
				...
				<ul>
					...
					<li>Anemia</li>
					<li>Bleeding in the Upper GI Tract</li>
				</ul>
				<p>
				...
				<h4>How to Prepare for Upper GI Endoscopy?</h4>
				<p>
				...
				<ul>
					<li>Non-steroidal anti-inflammatory drugs such as aspirin, ibuprofen (Advil), and naproxen (Aleve)</li>
				...
				<h4>How is upper GI endoscopy performed?</h4>
				<p>Upper GI endoscopy is conducted at a hospital or outpatient center.</p>
				<p>
				...
				<h4>What are the risks associated with upper GI endoscopy?</h4>
				<p>
				...
				<ul>
					<li>abnormal reaction to sedatives</li>
					<li>bleeding from biopsy</li>
					<li>accidental puncture of the upper GI tract</li>
				</ul>
				<p>
				...
				<ul>
					<li>swallowing difficulties</li>
					<li>throat, chest, and abdominal pain that worsens</li>
					<li>vomiting</li>
					<li>bloody or very dark stool</li>
					<li>fever</li>
				</ul>
